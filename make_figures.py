...
ax.set_title("Parametric sensitivity on the modular twin",fontsize=11)
...
axL.legend(frameon=False,fontsize=9); axL.set_title("Peak utilization vs. size")
...
axR.set_title("Exact ORC cost scales gently")
fig.savefig(D+"fig5_macro.pdf"); fig.savefig(D+"fig5_macro.png"); plt.close(fig)
...
axL.legend(frameon=False,fontsize=9); axL.set_title(f"Operational safety ($N$={bt['N']})")
...
axR.set_title("Tractability")
fig.savefig(D+"fig6_aws_perf.pdf"); fig.savefig(D+"fig6_aws_perf.png"); plt.close(fig)
